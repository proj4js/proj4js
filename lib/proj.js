...
goog.require("Proj4js.projCode");
goog.require("Proj4js.projCode.lcc");
//goog.require("Proj4js.projCode.tmerc");
//goog.require("Proj4js.projCode.aea");
 ...
 *
 * Parameters:
 * @param {string} srsCode - a code for map projection definition parameters.  These are usually
 * 							(but not always) EPSG codes.
 * @param {function()=} callback to be called when the constructor finishes
 * @constructor
 */
	  ...
	  */
      ...
      if ((srsCode.indexOf('GEOGCS') >= 0) ||
          ...
          (srsCode.indexOf('LOCAL_CS') >= 0)) {
    		...
    		return Proj4js.Proj[this.projName].apply(this);
/*
      ...
      if (Proj4js.defs[this.srsCode]) {
	      ...
	      this.deriveConstants();
		  this.initTransforms();
		 //return new Proj4js.Proj.lcc(this);
      }
};
...
Proj4js.Proj.prototype.initTransforms = function() {
	  ...
	  var projCode = Proj4js.projCode[this.projName];
	  if (projCode) {
	      this.projCode = new projCode(this);
	      //this.init();
 ...
 *
 */
Proj4js.Proj.prototype.parseDefs = function() {
...
Proj4js.Proj.identity = function () {
    //no-op for longlat
};
...
Proj4js.Proj.longlat = Proj4js.Proj.identity;
