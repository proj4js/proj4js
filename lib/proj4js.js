 ...
 * @param {Proj4js.Proj} dest - destination map projection for the transformation
 * @param {Proj4js.Point|{x: number,y: number,z: number}} point - the coordinate to be transformed
...
Proj4js.transform = function(source, dest, point) {
   ...
   if ( source.projName=="longlat") {
       ...
       source.projCode.inverse(point); // Convert Cartesian to longlat
   }
...
/**
 * @const
 * @type {Object.<string, Proj4js.EllipseType>}
 */
Proj4js.Ellipsoid = {
...
/**
 * @const
 * @type {Object.<string, Proj4js.DatumType>}
 */
Proj4js.Datum.defs = {
...
Proj4js.Datum.defs['OSB36'] = Proj4js.Datum.defs['OSGB36']; //as returned from spatialreference.org
