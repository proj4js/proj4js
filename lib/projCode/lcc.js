goog.provide('Proj4js.projCode.lcc');
...
/**
 * @constructor
 * @implements {Proj4js.projCode}
 * @param {Proj4js.Proj} defs
 */
Proj4js.projCode.lcc = function(defs) {


/**
 * lat0 - first standard parallel
 * @type {?number}
 */
 this.lat0 = null;
 
/**
 * lat0 - second standard parallel
 * @type {?number}
 */
 this.lat1 = null;
 ...
 */
 this.y0 = null;
/**
 * a- semi-major axis of the earth ellipse
 * @type {?number}
 */
 this.a = null;
 
/**
 * b- semi-minor axis of the earth ellipse
 * @type {?number}
 */
 this.b = null;
 
    //add in the parameters parsed out in the Proj4js.Proj object
    goog.mixin(this, defs);
...
//goog.inherits(Proj4js.Proj.lcc, Proj4js.Proj);//[this.projName]);
 ...
 */
Proj4js.projCode.lcc.prototype.forward = function(p) {
 ...
 * @return {Proj4js.Point|{x: number,y: number,z: number}|null} the resulting coordinate
 */
Proj4js.projCode.lcc.prototype.inverse = function(p) {
